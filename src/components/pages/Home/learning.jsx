          ...
          <div className="row align-items-center no-gutters">
            <div className="col-lg-3">
              ...
              <div className="section-title">
                ...
                <p>Basic and some advanced topics of HTML,CSS,JAVASCRIPT,REACT.You will do some industry level project, will create your portfolio</p>
                {/* Page Info */}
                ...
                <div className="single-room">
                 ...
                 <img  className="lazy" src="https://www.cnet.com/a/img/resize/6f59de6f421aca65461420ada94716b37c756c87/hub/2011/01/18/8d118cb0-fdc0-11e2-8c7c-d4ae52e62bcc/HTML5-wow.png?auto=webp&fit=crop&height=675&width=1200" alt />
                  ...
                  <div className="room-desc">
                    ...
                    <p>HTML forms the foundation, defining the structure of every web page with simplicity and clarity.</p>
                  </div>
                </div>
                <div className="single-room">
                  <a className="room-thumb d-block" href="room_details/31/four-points-by-sheraton-manhattan-midtown-west.html">
                  ...
                  <div className="room-desc">
                    ...
                    <p>CSS adds the vibrant colors and sleek styles, transforming static elements into dynamic designs</p>
                  </div>
                </div>
                <div className="single-room">
                  <a className="room-thumb d-block" href="room_details/31/four-points-by-sheraton-manhattan-midtown-west.html">
                  ...
                  <div className="room-desc">
                    ...
                    <p>Bootstrap injects efficiency, offering a robust framework for rapid development and responsive layouts</p>
                  </div>
                </div>
                <div className="single-room">
                  <a className="room-thumb d-block" href="room_details/31/four-points-by-sheraton-manhattan-midtown-west.html">
                  ...
                  <div className="room-desc">
                    ...
                    <p>JavaScript breathes life into web applications, fueling interactivity and dynamic functionality.</p>
                  </div>
                </div>
                <div className="single-room">
                  <a className="room-thumb d-block" href="room_details/31/four-points-by-sheraton-manhattan-midtown-west.html">
                  ...
                  <div className="room-desc">
                    ...
                    <p>React revolutionizes frontend development, with its component-based architecture and declarative approach, streamlining UI development like never before.</p>
                  </div>
                </div>
              </div>
            </div>
